    ...
    <section id="producto" style={{ backgroundColor: '#FBF5E9' }} className="section-pad">
      <div style={{ maxWidth: '1180px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '64px', alignItems: 'center' }} className="product-grid">
        ...
        <Reveal style={{ position: 'relative' }}>
          <div style={{ borderRadius: 'var(--radius)', overflow: 'hidden', transform: 'rotate(-1.5deg)', position: 'relative' }}>
            <Image
            ...
            <div className="chip-float" style={{
              ...
              background: 'white', borderRadius: '4px 14px 4px 14px',
              padding: '10px 18px',
        ...
        <Reveal delay={150}>
          ...
          <h2 style={{ fontFamily: 'var(--font-fraunces), Georgia, serif', fontWeight: 800, color: '#2E2A24', fontSize: 'clamp(2rem,4vw,2.8rem)', marginBottom: '16px', lineHeight: 1.1 }}>
